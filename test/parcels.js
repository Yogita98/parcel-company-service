        ...
        it("It should return all the parcels", (done) => {
            chai.request(server)
                ...
                .end((err, response) => {
                    ...
                    response.body.loadedParcels.should.not.be.eq(0);
                    done();
                });
        });
...
describe("GET /api/routes/parcels/:parcelId", () => {
    it("It should GET a parcel by ID", (done) => {
        ...
        chai.request(server)
            ...
            .end((err, response) => {
                ...
                // response.body.should.have.property('parcelId');
                // response.body.should.have.property('category');
                response.body.parcel.should.have.property('parcelId').eq(parcelId);
                response.body.parcel.should.have.keys('parcelId', 'category', 'parcelWeight');
                done();
            });
    });
    ...
    it("It should NOT GET a parcel by ID", (done) => {
        ...
        chai.request(server)
            ...
            .end((err, response) => {
                response.should.have.status(404);
                response.body.message.should.be.eq('The parcel with the provided ID does not exist');
                done();
            });
    });
    ...
    it("It should POST a new parcel", (done) => {
        ...
        chai.request(server)
            ...
            .end((err, response) => {
                ...
                response.body.should.have.property('parcelWeight').eq(3);
                done();
            });
    });
    ...
    it("It should NOT POST a new parcel without the appropriate properties", (done) => {
        ...
        chai.request(server)
            ...
            .end((err, response) => {
                ...
                response.body.message.should.be.eq('category or weight should be defined');
                done();
            });
    });
